...
export default declareVideoScript(
    async ({controller, recorder, visualizer, keyVisualizer, LM}) => {
        ...
        await controller.type([{key: "enter", repeat: 6, repeatDelay: 500}]);
        await controller.wait(1500);
        await controller.press("down");
        await controller.wait(500);
        await controller.type([{key: "enter", repeat: 3, repeatDelay: 500}]);
        await controller.wait(500);
        await controller.press("down");
        await controller.wait(500);
        await controller.type([{key: "enter", repeat: 2, repeatDelay: 500}]);
        await controller.wait(2000);

        await controller.type([{key: ["ctrl", "z"], repeat: 6, repeatDelay: 500}]);
        await controller.wait(1500);
        await controller.type([{key: ["ctrl", "y"], repeat: 6, repeatDelay: 500}]);
