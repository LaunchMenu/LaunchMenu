...
export const cssLiteralMappers = {
    ...
    borderWidth: (p: string | number) => p,
    borderTopWidth: (p: string | number) => p,
    borderBottomWidth: (p: string | number) => p,
    borderLeftWidth: (p: string | number) => p,
    borderRightWidth: (p: string | number) => p,
