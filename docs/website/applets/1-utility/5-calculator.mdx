...
For the forseeable future we will stick with Mathjs, but eventually we hope our own more math parser - that fits this applet better - will be used instead.
...
For some ideas we're however not sure if they should be part of this applet, or a 'advanced calculator' applet. We want to make sure that this applet remains very simple and intuitive to use, for every day tasks.
